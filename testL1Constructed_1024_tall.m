...
%% parameter settings
N = 256*4; M = N*4;    % matrix dimension M-by-N
...
hold off
LEG1 = legend('l_1 ADMM','l_1 FISTA','l_1 FB','l_1 FBAdaptive','l_1 FBPR', 'location', 'NorthEast');

save(['l1Constructed_Sp_',num2str(K),'_tall.mat'],'outputl1ADMM','outputl1FISTA','outputl1FB',...
    'outputl1FBRe','outputl1FBFR','outputl1FBPR','outputl1FBHS','outputl1FBDY','K')