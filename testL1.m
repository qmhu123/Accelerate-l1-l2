...
% % %     pm.delta = pm.lambda*0.4e3*lambdatrial;
% %     pm.delta = pm.lambda*(1.6e3 + 0.1e3*(lambdatrial-3));
% % % %     
% %     pm.ReSt = 20;
% %     
...
%% 30dB
pm.lambda =  1.2e-3;% M =256;

pmADMM = pm;
pmADMM.delta = pmADMM.lambda*1.3e2;
pmFISTA = pm;
pmFISTA.delta = pmFISTA.lambda*1.3e3;
% pmFISTA.delta = 1e-2;
pmFB = pm;
% pmFB.delta = pmFB.lambda*1.6e3;
pmFB.delta  = 1;
pmFBHB = pm;
...
% save(['l1data_Sp_',num2str(K),'_Snr_',num2str(SNR),'same_l','.mat'],'outputl1FISTA','outputl1ADMM','outputl1FB',...
